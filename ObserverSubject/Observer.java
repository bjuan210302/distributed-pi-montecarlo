...
{
    void update(boolean taskAvailable, com.zeroc.Ice.Current current);
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_update(Observer obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        boolean iceP_taskAvailable;
        iceP_taskAvailable = istr.readBool();
        inS.endReadParams();
        obj.update(iceP_taskAvailable, current);
