...
public interface MasterPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default int[] getTask(java.util.Map<String, String> context)
    {
        return _iceI_getTaskAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<int[]> getTaskAsync()
    {
        return _iceI_getTaskAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<int[]> getTaskAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<int[]> _iceI_getTaskAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<int[]> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getTask", null, sync, null);
    ...
    default void reportPartialResult(Point[] outside, Point[] inside)
    {
        reportPartialResult(outside, inside, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void reportPartialResult(Point[] outside, Point[] inside, java.util.Map<String, String> context)
    {
        _iceI_reportPartialResultAsync(outside, inside, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> reportPartialResultAsync(Point[] outside, Point[] inside)
    {
        return _iceI_reportPartialResultAsync(outside, inside, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> reportPartialResultAsync(Point[] outside, Point[] inside, java.util.Map<String, String> context)
    {
        return _iceI_reportPartialResultAsync(outside, inside, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_reportPartialResultAsync(Point[] iceP_outside, Point[] iceP_inside, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "reportPartialResult", null, sync, null);
        f.invoke(false, context, null, ostr -> {
                     PointSequenceHelper.write(ostr, iceP_outside);
                     PointSequenceHelper.write(ostr, iceP_inside);
